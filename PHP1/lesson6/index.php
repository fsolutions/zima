...
<body>
          ...
          <div class="top">
            <div class="headernetwork">
             <div class="footernetwork">
               ...
               <div class="cart">
                 <a href="#modal1" class="open_modal"><img src="img/cart.png"></a>
                 <p>
                  <?
                  require "config.php";
  ...
  <span class="modal_close">X</span>
      ...
      <input type="button" class="yellowbutton" value="PAY">
</div>
<div id="overlay"></div>
...
//заполнение базы данных картинками
...
//$size=$size1.$size;
//$size1=filesize($size);
//$sql = "INSERT INTO pics(max,size) VALUES ('img/$img[$i]',$size1)";
//$res=mysqli_query($connect,$sql);
//}
...
while ($data=mysqli_fetch_assoc($res)){
  ...
  $name=$data['name'];
  $price=$data['price'];
  echo "<p><a href=\"pic.php?photo=$id\"><img src=\"$a\" alt=\"logo\"</a></p>";
  echo "</div>";
